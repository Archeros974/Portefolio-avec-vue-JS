...
import {onMounted} from 'vue'
    onMounted (() =>{  const form = document.querySelector("form");
          ...
          <div id="comment-list" class="-my-4">
                ...
                <div class="flex-1 py-10 ">
                  ...
                  <div class="prose prose-sm mt-4 max-w-none text-gray-500">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                       Qui perferendis ratione eos ipsum incidunt, ut id debitis 
                       fugiat cumque omnis, exercitationem, dolores obcaecati maiores
                       eaque architecto delectus distinctio odio et.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="flex space-x-4 text-sm text-gray-500">
                <div class="flex-1 py-10 border-t border-gray-200">
                  ...
                  <div class="prose prose-sm mt-4 max-w-none text-gray-500">
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                       Iusto, enim vitae quasi culpa est, excepturi cum voluptatum
                       exercitationem id, deleniti similique maiores! Totam, itaque
                       praesentium quod ipsa quos ratione et.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="flex space-x-4 text-sm text-gray-500">
                <div class="flex-1 py-10 border-t border-gray-200">
                  ...
                  <div class="prose prose-sm mt-4 max-w-none text-gray-500">
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. 
                       Recusandae accusantium quae doloribus. Nobis ipsam libero 
                       asperiores a velit ab nemo facere molestias quisquam. Libero,
                       repudiandae dignissimos. Doloribus hic placeat soluta?</p>
                  </div>
                </div>
              </div>
          ...
          <div class="rounded-md bg-red-50 p-4">
            <div class="flex">
              <div class="flex-shrink-0">
                <svg class="h-5 w-5 text-red-400" x-description="Heroicon name: mini/x-circle"
        ...
        <form action="#" method="POST" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
          <div>
            ...
            <div class="mt-1">
              <input type="text" name="first-name" id="first-name" autocomplete="given-name"
               class="block w-full rounded-md border-warm-gray-300 py-3 px-4 text-warm-gray-900 
          ...
          <div>
            ...
            <div class="mt-1">
              ...
              class="block w-full rounded-md border-warm-gray-300 py-3 px-4 text-warm-gray-900 shadow-sm 
          ...
          <div class="sm:col-span-2">
            ...
            <div class="mt-1">
              ...
              class="block w-full rounded-md border-warm-gray-300 py-3 px-4 text-warm-gray-900 shadow-sm 
              focus:border-teal-500 focus:ring-teal-500" aria-describedby="message-max"></textarea>
            </div>
          </div>
          <div class="sm:col-span-2 sm:flex sm:justify-end">
            <button type="submit" class="mt-2 inline-flex w-full items-center justify-center rounded-md 
            border border-transparent bg-teal-500 px-6 py-3 text-base font-medium text-white shadow-sm 
